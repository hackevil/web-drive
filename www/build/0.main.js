...
var DrivePage = (function () {
    function DrivePage(popoverCtrl, data, alertCtrl, auth) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_data_service_data_service__ = __webpack_require__(202);
...
var FilterPipe = (function () {
    ...
    FilterPipe.prototype.transform = function (items, filter, state) {
        ...
        var keepDeleted = (state === __WEBPACK_IMPORTED_MODULE_1__providers_data_service_data_service__["b" /* PageState */].DELETED);
        return items.filter(function (item) {
            var lowercaseItem = item.name ? item.name.toLowerCase() : "";
            var otherFilter = ((item.type === "file")) ?
